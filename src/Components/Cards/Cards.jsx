        ...
        <div className="main-page relative">
          ...
          <div className="h-[80px]">
            ...
            <div className=" w-[45px] right-[-4px] top-25 align-middle">
              <span className="bell absolute text-[40px] right-3  text-cyan-600  ">
                <FaBell />
              </span>
            </div>
          </div>
          <div className="sub-main flex justify-between bg-white p-6 rounded-lg shadow-md">
           
            <div className="side">
              <Sidebar/>
            </div>
            <div className="sub-side" >
            <h2 className="title text-2xl font-bold px-12 mb-4">
              Choose a plan that's just right for you!
            </h2>
            <div className="head-btn">
              <h3 className="month bg-cyan-100 w-[140px] h-8 rounded-2xl text-center">
                Monthly
              </h3>
            ...
            <div className=" cards flex flex-wrap mt-20 align-middle justify-center">
              <div className="max-w-sm w-[300px]  rounded overflow-hidden shadow-lg m-4">
                <div className="card px-6 py-4">
                  <h2 className="font-bold text-[25px] mb-2">Basic</h2>
              ...
              <div className="max-w-sm w-[300px]  rounded overflow-hidden shadow-lg m-4">
                <div className="card px-6 py-4">
                  <h2 className="font-bold text-[25px] mb-2">Standard</h2>
              ...
              <div className="max-w-sm w-[300px]  rounded overflow-hidden shadow-lg m-4">
                <div className="card px-6 py-4">
                  <h2 className="font-bold text-[25px] mb-2">Premium</h2>
                  <p className="line-through text-sm text-red-500">
                    $359.99/mo
                  </p>
